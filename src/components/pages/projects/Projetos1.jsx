    ...
    return (
        <>
                   ...
                   <div className={style.projeto}>
                       <Link to={'/projeto1'} className={style.link}><img src="../../../public/img/projetos/site_em_construcao.jpg" alt="Projeto 1" className={style.img_projeto} /></Link>
                       <div>
                           <div className={style.nome_projeto}>
                           <Link to={'/projeto1'} className={style.link}><h3>Project Name 1</h3></Link>
